...
import 'universal_level_generator.dart';
...
class LevelService {
  ...
  /// Generate a level using the universal level generator
  static Future<GameLevel?> _generateMultilingualLevel(
    ...
    try {
      // Try the new universal system first
      final universalLevel = await UniversalLevelGenerator.generateLevel(
        world, 
        subWorld, 
        level,
      ...
      if (universalLevel != null) {
        return universalLevel;
      }
