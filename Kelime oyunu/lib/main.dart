...
class _AppInitializerState extends State<AppInitializer> {
  ...
  Future<void> _initializeApp() async {
    ...
    // Check if current language combination is supported by universal system
    _needsLanguageSelection = !_isLanguageCombinationSupported(
  ...
  /// Check if language combination is supported
